#!/usr/bin/env node
/**
 * Fetch coduri reducere Answear de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/answear.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/answear.ro";
const STORE_NAME  = "Answear";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-answear)" }
  });
