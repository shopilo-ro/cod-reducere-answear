#!/usr/bin/env python3
"""
Fetch coduri de reducere Answear de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/answear.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/answear.ro"
STORE_NAME = "Answear"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Answear de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-answear)"
    }
    try:
